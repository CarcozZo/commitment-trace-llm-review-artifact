...
| planner | `TENTATIVE_PLAN` | 4.244 | PG-C-CPB | `send_actionable:4` | 2.296407 | 0.0 | 14.713195 | 0.0/0.0 |
...
| executor | `PREPARED_ACTION` | 5.559 | PG-C-CPB | `send_informational_only:4` | 1.573434 | 0.0 | 16.102932 | 0.0/0.0 |
...
| verifier | `VERIFICATION_QUEUED` | 2.569 | PG-C-CPB | `send_actionable:2;send_informational_only:1;verify_first:1` | 0.24426 | 0.0 | 17.611937 | 0.25/0.0 |
...
| network_controller | `RESOURCE_RESERVED` | 6.675 | PG-C-CPB | `send_informational_only:4` | 1.5003 | 0.0 | 19.280631 | 0.0/0.0 |
...
| planner | `TENTATIVE_PLAN` | 3.618 | PG-C-CPB | `send_actionable:4` | 1.588017 | 0.0 | 16.260349 | 0.0/0.0 |
...
| executor | `PREPARED_ACTION` | 4.945 | PG-C-CPB | `send_informational_only:4` | 1.30989 | 0.0 | 17.496628 | 0.0/0.0 |
...
| verifier | `VERIFICATION_QUEUED` | 2.393 | PG-C-CPB | `send_actionable:2;verify_first:2` | 0.186457 | 0.0 | 18.812961 | 0.5/0.0 |
...
| network_controller | `RESOURCE_RESERVED` | 6.414 | PG-C-CPB | `send_actionable:4` | 4.504434 | 0.0 | 25.226759 | 0.0/0.0 |
...
| planner | `TENTATIVE_PLAN` | 3.370 | PG-C-CPB | `send_actionable:4` | 1.597959 | 0.0 | 3.36981 | 0.0/0.0 |
...
| executor | `PREPARED_ACTION` | 4.486 | PG-C-CPB | `send_actionable:2;send_informational_only:2` | 3.337818 | 0.0 | 6.173336 | 0.0/0.0 |
...
| verifier | `VERIFICATION_QUEUED` | 2.328 | PG-C-CPB | `send_actionable:2;verify_first:2` | 0.254706 | 0.0 | 7.453461 | 0.5/0.0 |
...
| network_controller | `RESOURCE_RESERVED` | 5.975 | PG-C-CPB | `send_informational_only:4` | 1.176902 | 0.0 | 8.947218 | 0.0/0.0 |
...
| planner | `VERIFICATION_QUEUED` | 2.560 | PG-C-CPB | `send_actionable:4` | 1.190061 | 0.0 | 9.392423 | 0.0/0.0 |
...
| executor | `PREPARED_ACTION` | 4.792 | PG-C-CPB | `send_informational_only:4` | 1.165069 | 0.0 | 10.590391 | 0.0/0.0 |
...
| verifier | `VERIFICATION_QUEUED` | 2.399 | PG-C-CPB | `send_actionable:4` | 0.356343 | 0.0 | 12.989429 | 0.0/0.0 |
...
| network_controller | `RESOURCE_RESERVED` | 6.389 | PG-C-CPB | `send_informational_only:4` | 1.206068 | 0.0 | 14.586679 | 0.0/0.0 |
...
| planner | `VERIFICATION_QUEUED` | 2.933 | PG-C-CPB | `send_actionable:4` | 0.969725 | 0.0 | 6.742953 | 0.0/0.0 |
...
| executor | `PREPARED_ACTION` | 5.165 | PG-C-CPB | `send_informational_only:4` | 1.154783 | 0.0 | 8.034218 | 0.0/0.0 |
...
| verifier | `VERIFICATION_QUEUED` | 2.822 | PG-C-CPB | `send_actionable:3;send_informational_only:1` | 0.344387 | 0.0 | 10.32684 | 0.0/0.0 |
...
| network_controller | `PREPARED_ACTION` | 5.165 | PG-C-CPB | `send_actionable:2;send_informational_only:2` | 2.751122 | 0.0 | 13.555002 | 0.0/0.0 |
