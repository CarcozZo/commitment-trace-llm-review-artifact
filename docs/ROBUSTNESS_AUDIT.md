...
- Subset dominance rates against selected PG-C-CPB rows under the same threshold, split, and regime.

## Threshold Summary

| Threshold | PG-C-CPB events | PG-C-CPB FCE/prog | Pressure BP FCE/prog | Static CPB FCE/prog | Dominance rate |
|---:|---:|---:|---:|---:|---:|
...
- Minimum label-threshold event count for PG-C-CPB: `5288`.
