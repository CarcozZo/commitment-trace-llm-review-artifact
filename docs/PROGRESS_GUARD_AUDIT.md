...
This audit documents the progress-deficit queue added to the progress-guarded
...
PG-C-CPB adds an online progress-deficit queue to the prior C-CPB controller.
...
| PG-C-CPB | 0.390827 | 0.222805 | 21.145766 | 27.2041% | 0.012471 |
| Action admission | 0.428490 | 0.251386 | 43.706691 | 21.5580% | 0.016822 |

Compared with C-CPB, PG-C-CPB reduces FCE/msg by 9.80%, increases
...
Compared with Pressure BP and Static CPB, PG-C-CPB preserves higher progress
while avoiding the high withheld-action operating region.  The supported claim
is therefore not that PG-C-CPB minimizes every scalar metric, but that the
...
can appear safe by suppressing receiver-side action.  PG-C-CPB prices this
...
feature appears in released `online_features_json` only for PG-C-CPB rows and is
...
figures that compare PG-C-CPB against same-control-surface ablations and audit
